<?php
// spotify.php
header("Access-Control-Allow-Origin: *"); // Libera para qualquer porta (Vite, Localhost, etc)
...
// 1. Pede o Access Token (Expira em 1h, por isso usamos o Refresh Token)
$ch = curl_init();
