...
export const pt = {
  ...
  minigames: {
    ...
    common: {
      score: "Pontos", record: "Recorde", level: "Nível", max: "Máx", moves: "Jogadas",
      time: "Tempo", win: "Você Venceu!", gameOver: "Fim de Jogo", playAgain: "Jogar Novamente",
      restart: "Reiniciar", back: "Sair", quit: "Menu Principal", nextLevel: "Próxima Fase",
      tryAgain: "Tentar Novamente", exit: "Sair"
    },
    descriptions: {
    ...
    memory: {
      title: "Tech Memory", subtitle: "Teste sua memória em diferentes níveis.",
      bestScore: "Recorde", moves: "Movimentos", winTitle: "Mandou Bem!",
      winSubtitle: "Você completou em", newRecord: "NOVO RECORDE!", playAgain: "Jogar Novamente",
      modes: { easy: "Fácil", medium: "Médio", hard: "Difícil" }
    },
    snake: { title: "Dev Snake", help: "Use as setas para mover" },
    sequence: { title: "Cyber Sequence", turn: "Sua vez!", watch: "Observe...", wrong: "Errou!" },
    matrix: { title: "Matrix Recall", memorize: "MEMORIZE!", repeat: "Repita o padrão.", success: "SUCESSO!", fail: "FALHA NO SISTEMA" },
    decryptor: { title: "Decryptor", accessGranted: "ACESSO LIBERADO!", accessDenied: "ACESSO NEGADO", cracked: "Você quebrou a criptografia.", enter: "ENTER" },
    zip: {
      title: "Logic Quiz", hint: "Dica:", correct: "CORRETO!", wrong: "ERRADO!", hackComplete: "HACK COMPLETO!", placeholder: "Resposta...",
      levels: [
